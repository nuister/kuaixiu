...
public abstract class LiteHttpClient {
    public static final int FLAG_NET_DISABLE_ALL    = NetType.None.value;
    public static final int FLAG_NET_DISABLE_MOBILE = NetType.Mobile.value;
    public static final int FLAG_NET_DISABLE_WIFI   = NetType.Wifi.value;
    public static final int FLAG_NET_DISABLE_OTHER  = NetType.Other.value;
