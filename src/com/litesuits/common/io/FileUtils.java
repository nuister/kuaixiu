...
public class FileUtils {
    ...
    public static final String LOCAL_AVATAR = ApplicationBase.instance.getExternalCacheDir() + "/local_avatar.jpg";
    ...
    public static File createImageFile() throws IOException {
        ...
        File storageDir = FileUtils.getCameraPath();
    ...
    private final static String DCIM = "/mnt/sdcard/" + android.os.Environment.DIRECTORY_DCIM;
    private final static String INTERNAL_CAMERA = "/mnt/sdcard/dcim/camera";
    private final static String EXTERNAL_CAMERA = "/mnt/storage/sdcard1/dcim/camera";

    public static File getCameraPath() {
        File dcimFile = new File(DCIM);
        File externalFile = new File(EXTERNAL_CAMERA);
        File internalFile = new File(INTERNAL_CAMERA);
        File result = dcimFile;
    ...
    public static String getRealPathFromURI(Uri contentUri) {
        ...
        try {
            ...
            cursor = ApplicationBase.instance.getContentResolver().query(contentUri, proj, null, null, null);
            if (cursor != null) {
    ...
    public static File compressPicture(File source, int maxSize) {
        try {
            ...
            Bitmap compressed = BitmapFactory.decodeStream(new FileInputStream(source), null, options);
            return convertBitmapToFile(ApplicationBase.instance, compressed);
    ...
    private static final String EXTERNAL_CACHE = ApplicationBase.instance.getExternalCacheDir().getAbsolutePath();
